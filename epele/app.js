...
(function(){
  ...
  const crowned = document.querySelector('#crowned')
  ...
  class checker {
    ...
    checkIfKing() {
      if (this.coordY == 8 && !this.king && this.color == "white") {
        this.king = true;
        this.id.classList.add('king-1')
        playSound(crowned);
      }
      if (this.coordY == 1 && !this.king && this.color == "black") {
        this.king = true; this.king = true;
        this.id.classList.add('king-2')
        playSound(crowned);
      }
    }
  }
  ...
  if(the_checker[1].color == "white")
    ...
    score.innerHTML = "Player Onw Wins";
  }
